...
/*!
 ...
 Any Comminications returned in the result will be posted as UILocalNotifications
 @param manager
 @param communications Communications retrieved from the Gimbal Manager
 @return Any Comminications you want Gimbal to post a UILocalNotification for
 */
- (NSArray *)communicationManager:(GMBLCommunicationManager *)manager shouldPresentLocalNotificationForCommunications:(NSArray *)communications;
